                ...
                <div>
                    ...
                    <div className = "dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-dark">
                            { /* HR */ }
                            <li>
                                <button className = "dropdown-item" type = "button" onClick = { handleDepartment }> HR </button>
                            </li>
                            { /* Sales */ }
                            <li>
                                <button className = "dropdown-item" type = "button" onClick = { handleDepartment }> Sales </button>
                            </li>
                            { /* IT */ }
                            <li>
                                <button className = "dropdown-item" type = "button" onClick = { handleDepartment }> IT </button>
                            </li>
                        </ul>
                    </div>
                </div>
